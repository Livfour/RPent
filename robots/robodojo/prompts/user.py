...
- layout id: {{layout_id}}
- embodiment: dual ARX-X5 (absolute end-effector pose control)
- vla available: {{vla_available}}
"""
...
each action verify its observable gate, preserve achieved relations, and stop
with finish after a fresh status check."""
